...
namespace GarenOP
{
    ...
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("GarenOP yuklendi!");
            ...
            if (sender.IsMe)
            {
                ...
                if (args.SData.Name.ToLower().Contains("basic"))
                {
                   ...
                   if(Dizzy==true)
                    ...
                    {
                        Dizzy = false;
                         Game.PrintChat("Artýk baþýn dönmüyor!");
                    }
                    }
                ...
                {
                    Game.Say("/all BEN EVE GÝDÝYORUM AMINA KODUMUN ÇOCUÐU.");
                }
                ...
                else if (args.SData.Name == "GarenW")
                {
                    if (W.IsReady() && wardCount >=3)
                    {
                        ...
                        pos.X -= 160;
                        PutWard(pos);
                        Game.Say("/all ILLUMINATEYYYYYYYYYYYYY");
                    }
                }
                ...
                else if (args.SData.Name == "GarenE")
                {
                    if (E.IsReady())
                    {
                        E.Cast();
                        Dizzy = true;
                        Game.Say("/all BAÞIM DÖNÜYORRRRRRRRRR GÖREMÝYORUMMMMMMM");
        ...
        private static void OnGameUpdate(EventArgs args)
        {
            try
            {
                ...
                if (ObjectManager.Player.Deaths ==3)
                {
                    try
                    {
                        Game.Say("/all TAMAMÝYLE BAÞARISIZIM. BEN ÇIKIYORUM.");
